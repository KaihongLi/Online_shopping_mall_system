<%@page import="edu.fzu.tmall.pojo.Product"%>
<%@page import="edu.fzu.tmall.pojo.Category"%>
				...
				<table class="editTable">
					...
					<tr>
						...
						<td><input id="originalPrice"
							value="${product.originalPrice}" name="originalPrice"
					...
					<tr>
						...
						<td><input id="stock" value="${product.stock}"
							name="stock" type="text" class="form-control"></td>
					</tr>
					<tr>
						<td>类别</td>
						<td>
